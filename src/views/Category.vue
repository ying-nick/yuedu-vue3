  ...
  <div class="fl">
    <div class="ca-container">
        ...
        <ul class="list">
          ...
          <li class="ca_class">
            ...
            <el-tabs v-model="activeName" v-show="seen" @tab-click="getMaleCategoryList">
              <el-tab-pane :label="item.categoryName" :name="index==0?'first':''" v-for="(item,index) in MaleBookCategories" :key="item"></el-tab-pane>
            </el-tabs>
            <el-tabs v-model="activeName" v-show="!seen" @tab-click="getFemaleCategoryList">
              <el-tab-pane :label="item.categoryName" :name="index==0?'first':''" v-for="(item,index) in FemaleBookCategories" :key="item"></el-tab-pane>
            </el-tabs>
          </li>
        </ul>
      </div>
      ...
      <div class="ca-down">
        ...
        <el-pagination background layout="prev, pager, next" :key="elementui_page_component_key" :total="total" @current-change="toChangePage"
